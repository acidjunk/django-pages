...
urlpatterns = [
    ...
    url(r'^page-youtubelink/delete/(?P<pk>\d+)$', views.PageYoutubeLinkDelete.as_view(),
        name='page-youtubelink-delete'),
    ...
    url(r'^page-facebooklink/delete/(?P<pk>\d+)$', views.PageFacebookLinkDelete.as_view(),
        name='page-facebooklink-delete'),
